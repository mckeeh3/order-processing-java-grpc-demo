...
public class ShipOrdersByDateView extends AbstractShipOrdersByDateView {
  static final Logger log = LoggerFactory.getLogger(ShipOrdersByDateView.class);

  public ShipOrdersByDateView(ViewContext context) {
  }
