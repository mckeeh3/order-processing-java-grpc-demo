...
public class OrderItemIntegrationTest {
  ...
  public void createOrderItemOnNonExistingEntity() throws Exception {
    ...
    // client.createOrderItem(OrderItemApi.CreateOrderItemCommand.newBuilder().build())
  ...
  public void shippedOrderItemOnNonExistingEntity() throws Exception {
    // TODO: set fields in command, and provide assertions to match replies
    // client.shippedOrderItem(OrderItemApi.ShippedOrderItemCommand.newBuilder().build())
    //         .toCompletableFuture().get(5, SECONDS);
  }
